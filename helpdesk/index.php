                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Bem-Vindo(a) ao HelpDesk!</h1>
                                    </div>
                                    <form class="user" action="Backend/validarLogin.php" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="matr" name="mat" aria-describedby="emailHelp"
                                                placeholder="Matricula">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="pwd" name="senha" placeholder="Password">
                                        </div>
                                        <div class="form-group">
